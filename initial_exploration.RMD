...
workforce_results <- workforce_freq %>%
  ...
  dplyr::select(year, 
                "Actual number of women in the workforce" = total, 
                "Forecast number of women in the workforce" = forecast_workforce) %>%
...
ggplot(workforce_results[workforce_results$year > 2005, ], 
  ...
  labs(title = "If women had been fired at the same rate as men...",
       ...
       x = "Year",
       y = "Forecast or actual number of women in the workforce",
       colour = " ")+
  BIT_theme+
